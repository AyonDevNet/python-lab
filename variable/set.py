#set is collection of unique iteam and it is not allow to idexing 
# #becuase it is not allow to indexing

#we can add and remove , but we cannot modified or repalce
